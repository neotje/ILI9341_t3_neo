// https://github.com/neotje/ILI9341_t3_neo
...
#ifndef _ILI9341_t3_neoH_
#define _ILI9341_t3_neoH_
...
class ILI9341_t3_neo : public Print
{
public:
	ILI9341_t3_neo(uint8_t _CS, uint8_t _DC, uint8_t _RST = 255, uint8_t _MOSI = 11, uint8_t _SCLK = 13, uint8_t _MISO = 12);
	void begin(void);
...
protected:
	...
	int buffer_size = ILI9341_TFTHEIGHT * ILI9341_TFTWIDTH;
	int buffer_byte_size = ILI9341_TFTHEIGHT * ILI9341_TFTWIDTH * 2;
...
#define TCR_MASK (LPSPI_TCR_PCS(3) | LPSPI_TCR_FRAMESZ(31) | LPSPI_TCR_CONT | LPSPI_TCR_RXMSK)
	...
	void beginSPITransaction(uint32_t clock = ILI9341_SPICLOCK) __attribute__((always_inline))
	{
		...
		if (!_dcport)
			_spi_tcr_current = IMXRT_LPSPI4_S.TCR; // Only if DC is on hardware CS
		if (_csport)
...
public:
	...
	void initButton(ILI9341_t3_neo *gfx, int16_t x, int16_t y,
					uint8_t w, uint8_t h,
